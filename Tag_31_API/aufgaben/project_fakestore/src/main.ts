...
const PH = {
  ...
  category: PL<HTMLElement>("#category_buttons"),
  sort: PL<HTMLDivElement>("#sort_btn"),
  searchToggle: PL<HTMLButtonElement>("#search_toggle"),
  searchbar: PL<HTMLDivElement>("#searchbar"),
