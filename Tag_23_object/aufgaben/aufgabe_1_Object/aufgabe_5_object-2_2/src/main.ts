...
const singersSortedByName = [...singers].sort((a, b) => a.name.localeCompare(b.name))

console.log(singersSortedByName)

const singersSortedByStart = [...singers].sort((a, b) => a.period_active.start - b.period_active.start)

console.log(singersSortedByStart)
